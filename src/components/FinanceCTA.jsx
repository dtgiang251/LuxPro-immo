...
const FinanceCTA = () => {
  return (
    <div className="relative h-auto md:h-[495px] self-stretch bg-gray-50 overflow-hidden">
      <svg 
        className="absolute right-0 top-[52px] w-[442px] h-[376px] fill-primary hidden md:block" 
        width="435" 
        height="373" 
        viewBox="0 0 435 373" 
        fill="none" 
      ...
      <div className="relative flex flex-col items-start gap-12 w-full md:w-[513px] h-auto md:h-[305px] px-6 py-12 md:px-0 md:py-0 md:ml-25 md:mt-[95px] z-10">
        <div className="flex flex-col items-start gap-5 self-stretch">
          ...
          <p className="self-stretch text-black font-poppins text-base leading-[26px]">
        ...
        <div className="flex flex-col md:flex-row items-start gap-3.5">
          ...
          <button className="flex justify-center items-center gap-2 rounded-[10px] border border-primary px-8 py-3">
            ...
            <span className="text-primary text-center font-poppins text-base leading-[26px]">Estimate the home</span>
          </button>
        </div>
      </div>
    </div>
