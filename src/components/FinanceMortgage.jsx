...
const FinanceMortgage = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-25 self-stretch bg-white px-6 py-12 lg:py-30 max-w-[1280px] m-auto">
      <div className="flex items-center gap-3.5 w-full md:w-[45%] h-auto lg:h-[577px] relative">
      ...
      <div className="md:w-[55%]flex flex-col items-start gap-10 flex-1">
        <div className="flex flex-col items-start gap-3.5 self-stretch">
          ...
          <h2 className="self-stretch text-black font-poppins text-[38px] font-bold leading-[44px] mb-10">
            A mortgage tailored to work for you
          </h2>
        </div>

        <div className="flex flex-col items-start gap-5 self-stretch">
          <p className="self-stretch text-text-gray font-opensans text-sm font-bold leading-[14px] mb-2">
            Discover the advantages of financing your home with our Mortgage
          </p>

          <div className="flex flex-col md:flex-row gap-2.5 self-stretch mb-10">
        ...
        <div className="md:flex items-start gap-5">
          <button className="w-full md:w-auto mb-5 md:mb-0 flex justify-center items-center gap-4 rounded-[10px] border border-primary bg-primary px-8 py-3">
            <span className="text-white text-center font-poppins text-base leading-[26px]">Contact us now</span>
          </button>
          <button className="w-full md:w-auto flex justify-center items-center gap-4 rounded-[10px] border border-primary px-8 py-3">
