...
const Navigation = () => {
  ...
  return (
    <>
      <nav className="w-full border-b border-gray-200 bg-white relative z-[9999]">
        <div className="mx-auto max-w-[1240px] px-5 py-4 md:px-10 lg:px-5">
          ...
          <Link to="/">
            <img
              ...
              alt="LUX-PRO-IMMO"
              className="h-14 w-20 md:h-16 md:w-24 outline-none"
            />
          </Link>
          ...
          <div className="hidden flex-1 flex-col items-end gap-4 lg:flex">
            <div className="flex items-center gap-5">
              ...
              <div className="flex cursor-pointer items-center gap-2 text-xs ml-5">
      ...
      {isMenuOpen && (
        <div className="absolute inset-0 z-50 lg:hidden">
          <div className="flex flex-col">
            <div className="relative flex flex-col justify-center pt-[87px]">
              <img
            ...
            <div className="grid grid-cols-2 bg-white w-[90%] m-auto rounded-b-[20px]">
              <Link to="/finance" className="flex items-center justify-center gap-2 border-r-2 border-[#8f8f8f] py-4" onClick={() => setIsMenuOpen(false)}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
