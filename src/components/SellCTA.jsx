...
const SellCTA = () => {
  return (
    <div className="relative self-stretch bg-gradient-to-r from-primary to-[#750836] overflow-hidden">
      <svg 
      ...
      <div className='max-w-[1280px] m-auto px-6 relative overflow-hidden'> 
          <div className="relative flex flex-col items-start gap-12 w-full md:w-[513px] h-auto pb-[120px] py-12 md:py-24  z-10">
            ...
            <div className="w-full md:flex flex-col md:flex-row items-start gap-3.5">
              <button className="w-full mb-[14px] md:mb-0 flex justify-center items-center gap-4 rounded-[10px] border border-white bg-primary px-8 py-3">
                <span className="text-white text-center font-poppins text-base leading-[26px]">Contact us now</span>
              </button>
              <button className="bg-[#85053B] w-full flex justify-center items-center gap-2 rounded-[10px] border border-white px-8 py-3">
          ...
          <img 
            ...
            alt="House"
            className="absolute right-0 md:right-[-60%] lg:right-0 bottom-[-20%] md:top-0 object-cover"
          />
      </div>
    </div>
  );
